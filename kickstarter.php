...
if (isset($_POST)) {
    ...
    if (isset($_POST['folder_name']) && isset($_POST['main_dir'])) {
    ...
    if (isset($_POST['file_name']) && isset($_POST['main_dir']) && isset($_POST['file_mime'])) {
    ...
    if (isset($_POST['delete_it']) && isset($_POST['file_path'])) {
